...
/**
 * Testing Vimeo.com Sign up pages with Page Object Pattern. This class shows
 * how to use page objects for testing. Compare with "VimeoSignupTest.java"
 * class, and see how to use page objects.
 * 
 * By using page objects, we do not have to remember all the page logic (each
 * input or element id, name, or css-selector) to write test. And Page to Page
 * navigation looks more clear.
 * 
 * @author Chon Chung
 */
public class VimeoSignupTest_withPageObject {
	...
	/**
	 * Test the signup page with valide inputs data. Expected result:
	 * Successfully signed up, and profile page displayed with
	 * first_and_LastName
	 */
	@Test
	...
	/**
	 * Test the signup page with invalid-format-email address. Expected result:
	 * "Please enter a valid email address" displayed
	 */
	@Test
	...
	/**
	 * Test the signup page with missing password. Expected result: "Please
	 * enter your password" displayed
	 */
	@Test
	...
	/**
	 * Get the testing data. You could make this method to access external
	 * testing data from Database or Excel files. But for this simple test, I am
...
/**
 * Further reading: 1. Selenium webdriver page object:
 * http://stackoverflow.com/questions/10315894/selenium-webdriver-page-object 2.
 ...
 * 3. PageFactory http://code.google.com/p/selenium/wiki/PageFactory 4. Ben
 * Burton's WebDriver Best Practices Video -- http://vimeo.com/44133409
